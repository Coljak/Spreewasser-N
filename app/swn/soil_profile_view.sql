-- soil_profile_all source-- this SQL is meant for documentation purposes. It is the 'soil_profile_al' iewf he sqite monica/ buek db.
...
SELECT 
       ...
       INSTR (LOWER ([h].[horiz]), "gr") > 0
AND INSTR (LOWER ([h].[horiz]), "gro") = 0 AS [is_in_groundwater], 
