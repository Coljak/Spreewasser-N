# Metadata parsed from sample 
result= {'dates': array(['2025-08-01', 
       ...
       'variables': [
           {
                ...
                }, 
                {
                    ...
                    'type': 'OId', 
                    'unit': 'm3 m-3', 
                    'longname': 'Pflanzenverfügbares Bodenwasser', 
                    'is_layer_average': False, 
                    'layer_depth': None
                    }, 
                    {
                    'name_lower': 'mois_avg_0_30', 
                    'name': 'Mois', 
                    'fromLayer': 0, 
                    'toLayer': 2, 
                    'displayName': '', 
                    'id': 67, 
                    'jsonInput': '["Mois", [1, 3, "AVG"]]', 
                    'layerAggOp': 0, 
                    'organ': 6, 
                    'timeAggOp': 0, 
                    'type': 'OId', 
                    'unit': 'm3 m-3', 
                    'longname': 'Bodenfeuchtigkeit 0cm-30cm', 
                    'layer_depth': '_avg_0_30', 
                    'is_layer_average': True
                    }, 
                    {
                        'name_lower': 'mois_avg_30_60', 
                    'name': 'Mois', 
                    'fromLayer': 3, 
                    'toLayer': 5, 
                    'displayName': '', 
                    'id': 67, 
                    'jsonInput': '["Mois", [4, 6, "AVG"]]', 
                    'layerAggOp': 0, 
                    'organ': 6, 
                    'timeAggOp': 0, 
                    'type': 'OId', 
                    'unit': 'm3 m-3', 
                    'longname': 'Bodenfeuchtigkeit 30cm-60cm', 
                    'layer_depth': '_avg_30_60', 
                    'is_layer_average': True
                    }, 
                    {
                        'name_lower': 'mois_avg_40_90', 
                        'name': 'Mois', 
                        'fromLayer': 4, 
                        'toLayer': 8, 
                        'displayName': '', 
                        'id': 67, 
                        'jsonInput': '["Mois", [5, 9, "AVG"]]', 
                        'layerAggOp': 0, 
                        'organ': 6, 
                        'timeAggOp': 0, 
                        'type': 'OId', 
                        'unit': 'm3 m-3', 
                        'longname': 'Bodenfeuchtigkeit 40cm-90cm', 
                        'layer_depth': '_avg_40_90', 
                        'is_layer_average': True
                    }, 
                    {
                        'name_lower': 'mois_avg_0_60', 
                        'name': 'Mois', 
                        'fromLayer': 0, 
                        'toLayer': 5, 
                        'displayName': '', 
                        'id': 67, 
                        'jsonInput': '["Mois", [1, 6, "AVG"]]', 
                        'layerAggOp': 0, 
                        'organ': 6, 
                        'timeAggOp': 0, 
                        'type': 'OId', 
                        'unit': 'm3 m-3', 
                        'longname': 'Bodenfeuchtigkeit 0cm-60cm', 
                        'layer_depth': '_avg_0_60', 
                        'is_layer_average': True}
                    ]
                    }