...
urlpatterns = [
    ...
    path('Dashboard/save/', views.save_user_field, name='save-user-field'),
    path('Dashboard/load/', views.get_user_fields, name='get-user-fields'),
    path('Dashboard/update/', views.update_user_field, name='update-user-fields'),
