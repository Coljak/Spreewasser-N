...
urlpatterns = [
    ...
    # path('drought/get-soil-profile-form/<int:user_field_id>/', views.get_soil_profile_form, name='get_soil_profile_form'),
    path('drought/get-soil-profile/', views.get_soil_profile, name='get_soil_profile'),
