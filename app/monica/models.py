...
class UserEnvironmentParameters(models.Model):
    ...
    atmospheric_co2s = models.JSONField(blank=True, null=True)
    yearly_co2_values = models.JSONField(blank=True, null=True)
...
class UserSoilOrganicParameters(models.Model):
    ...
    code_vnit = models.IntegerField(null=True, blank=True)
    code_tnit = models.IntegerField(null=True, blank=True)
    code_rationit = models.IntegerField(null=True, blank=True)
    code_hourly_wfps_nit = models.IntegerField(null=True, blank=True)
    code_pdenit = models.IntegerField(null=True, blank=True)
    code_ratiodenit = models.IntegerField(null=True, blank=True)
    code_hourly_wfps_denit = models.IntegerField(null=True, blank=True)
