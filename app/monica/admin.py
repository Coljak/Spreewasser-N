...
admin.site.register(models.WorkstepAutomaticHarvest, admin.ModelAdmin)
admin.site.register(models.WorkstepNDemandFertilization, admin.ModelAdmin)
...
admin.site.register(models.SeedHarvestclimateStation, LeafletGeoAdmin)
admin.site.register(models.SeedHarvestDates, admin.ModelAdmin)
admin.site.register(models.Output, admin.ModelAdmin)
admin.site.register(models.OutputEvent, admin.ModelAdmin)
admin.site.register(models.OutputAggregation, admin.ModelAdmin)
admin.site.register(models.BBCHStage, admin.ModelAdmin)
