...
def run_consumer(path_to_output_dir = './out_csv', leave_after_finished_run = True, server = {"server": None, "port": None}, shared_id = None):
    ...
    config = {
        ...
        "shared_id": shared_id,
        "out": path_to_output_dir if path_to_output_dir else os.path.join(os.path.dirname(__file__), './out_csv'),
